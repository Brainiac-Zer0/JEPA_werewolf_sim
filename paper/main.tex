...
models (\texttt{ck\_base}, \texttt{ck\_social}) are trained at $200\times5$
games$\times$cycles for $5$ epochs, while the language models
...
significant, so the extra budget goes to the free components). Every rung is
evaluated at $450$ games across seeds $\{1337, 2718, 3141\}$; sweeps (Table~2) use
$300$ games across $\{1337, 2718\}$ against \texttt{ck\_full}.
